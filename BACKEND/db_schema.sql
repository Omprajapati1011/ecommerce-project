...
CREATE TABLE `cart_item_modifiers` (
  ...
  KEY `fk_cart_item_mod_modifier_portion` (`modifier_portion_id`),
  KEY `fk_cart_item_mod_created_by` (`created_by`),
  KEY `fk_cart_item_mod_updated_by` (`updated_by`),
  CONSTRAINT `fk_cart_item_mod_cart_item` FOREIGN KEY (`cart_item_id`) REFERENCES `cart_items` (`cart_item_id`) ON DELETE CASCADE,
  CONSTRAINT `fk_cart_item_mod_modifier_portion` FOREIGN KEY (`modifier_portion_id`) REFERENCES `modifier_portion` (`modifier_portion_id`) ON DELETE CASCADE,
  CONSTRAINT `fk_cart_item_mod_created_by` FOREIGN KEY (`created_by`) REFERENCES `user_master` (`user_id`),
  CONSTRAINT `fk_cart_item_mod_updated_by` FOREIGN KEY (`updated_by`) REFERENCES `user_master` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `order_item_modifiers` (
  ...
  UNIQUE KEY `unique_order_item_modifier` (`order_item_id`,`modifier_portion_id`),
  KEY `fk_order_item_mod_modifier_portion` (`modifier_portion_id`),
  KEY `fk_order_item_mod_created_by` (`created_by`),
  KEY `fk_order_item_mod_updated_by` (`updated_by`),
  CONSTRAINT `fk_order_item_mod_order_item` FOREIGN KEY (`order_item_id`) REFERENCES `order_items` (`order_item_id`) ON DELETE CASCADE,
  CONSTRAINT `fk_order_item_mod_modifier_portion` FOREIGN KEY (`modifier_portion_id`) REFERENCES `modifier_portion` (`modifier_portion_id`) ON DELETE RESTRICT,
  CONSTRAINT `fk_order_item_mod_created_by` FOREIGN KEY (`created_by`) REFERENCES `user_master` (`user_id`),
  CONSTRAINT `fk_order_item_mod_updated_by` FOREIGN KEY (`updated_by`) REFERENCES `user_master` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
