...
INSERT INTO user_master (user_id, name, email, password, role, is_deleted, created_by, updated_by)
VALUES
...
INSERT INTO product_categories (product_id, category_id)
SELECT product_id, category_id FROM product_master;
...
FROM product_master p WHERE p.name = 'iphone_15_pro_max'
UNION ALL
...
FROM product_master p WHERE p.name = 'samsung_galaxy_s24_ultra'
UNION ALL
...
FROM product_master p WHERE p.name = 'redmi_note_13_pro'
UNION ALL
...
FROM product_master p WHERE p.name = 'oneplus_12'
UNION ALL
...
FROM product_master p WHERE p.name = 'samsung_55_qled_4k'
UNION ALL
SELECT p.product_id, 'Panel Size', '43 inch', 15, 1, 0, 1, 1
FROM product_master p WHERE p.name = 'lg_43_led_full_hd'
UNION ALL
SELECT p.product_id, 'Panel Size', '65 inch', 8, 1, 0, 1, 1
FROM product_master p WHERE p.name = 'sony_65_oled_4k'

-- Apple Watch straps
UNION ALL
SELECT p.product_id, 'Strap Material', 'Silicone', 25, 1, 0, 1, 1
FROM product_master p WHERE p.name = 'apple_watch_series_9'
UNION ALL
...
FROM product_master p WHERE p.name = 'galaxy_watch_6'

-- Mi Smart Band colors
UNION ALL
SELECT p.product_id, 'Strap Color', 'Black', 40, 1, 0, 1, 1
FROM product_master p WHERE p.name = 'mi_smart_band_8'
UNION ALL
...
FROM product_master p WHERE p.name = 'spigen_rugged_case_iphone_15'
UNION ALL
SELECT p.product_id, 'Pack', 'Charger only', 60, 1, 0, 1, 1
FROM product_master p WHERE p.name = 'oneplus_fast_charger'
UNION ALL
SELECT p.product_id, 'Pack', 'Charger + Cable', 40, 1, 0, 1, 1
FROM product_master p WHERE p.name = 'oneplus_fast_charger'
UNION ALL
SELECT p.product_id, 'Color', 'Black', 80, 1, 0, 1, 1
FROM product_master p WHERE p.name = 'boat_rockerz_450'
UNION ALL
SELECT p.product_id, 'Color', 'Black', 30, 1, 0, 1, 1
FROM product_master p WHERE p.name = 'sony_wh_1000xm5';

-- =====================
-- Portions (portion_master) - storage variants
-- =====================
...
FROM product_master p WHERE p.name = 'poco_x6'
UNION ALL
...
FROM product_master p WHERE p.name = 'oneplus_nord_3'
UNION ALL
