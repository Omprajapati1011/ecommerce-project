...
async function seed() {
  ...
  try {
    ...
    await conn.query(`
      INSERT INTO cart_items (cart_item_id, cart_id, product_id, quantity, price, is_deleted, created_by, updated_by) VALUES
        (1, 1, 3, 1, 129999.00, 0, 2, 2),
        (2, 1, 5, 1, 24999.00, 0, 2, 2),
        (3, 2, 1, 1, 149999.00, 0, 3, 3),
        (4, 2, 8, 1, 29999.00, 0, 3, 3)
    `);
    ...
    await conn.query(`
      INSERT INTO order_items (order_item_id, order_id, product_id, product_name, quantity, price, discount, tax, total, is_deleted, created_by, updated_by) VALUES
        (1, 1, 3, 'Samsung Galaxy S24 Ultra', 1, 129999.00, 5000.00, 6500.00, 131499.00, 0, 2, 2),
        (2, 1, 5, 'Redmi Note 13 Pro', 1, 24999.00, 5000.00, 500.00, 20499.00, 0, 2, 2),
        (3, 2, 1, 'Apple iPhone 15 Pro Max', 1, 149999.00, 5000.00, 7500.00, 152499.00, 0, 3, 3),
        (4, 2, 8, 'OnePlus Nord 3', 1, 29999.00, 0.00, 1500.00, 31499.00, 0, 3, 3)
    `);
